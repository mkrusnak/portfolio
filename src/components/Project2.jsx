  ...
  return (
    ...
    >
      <div className="p-1 md:p-10 md:pr-5 md:pt-5 flex-col ">
        <h1 className="text-center text-gray-800 pb-3 text-4xl font-burtons ">
          Find a Friend
        </h1>
        <h4 className="italic py-2 indent-1 text-lg text-gray-800">
          Pet adoption service that helps you find animals available for
          adoption and more.
        </h4>
        <ul className="space-y-2 text-lg text-gray-700">
          ...
          <li>
            • Implemented 3rd party REST API using Axios to get data and filter
            it based on users input
          </li>
          <li>• Connected MongoDB to give user the ability to CRUD models</li>
          <li>
            • Set up authentication using Express-Session and bcryptJs to hash
            passwords
          </li>
        </ul>
