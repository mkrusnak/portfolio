    ...
    >
      ...
      <div className="p-1 md:p-10 md:pt-5  flex-col ">
        ...
        <h4 className="italic py-2 indent-1 text-lg text-gray-800">
          Car enthusiast forum with ability to post, comment, send private
          messages, list cars for sale and more.
        </h4>
        <ul className="space-y-2 text-gray-700 text-lg">
          <li>
            • Single page application developed using MongoDB, ExpressJs, React
            and NodeJs
          </li>
          <li>
          ...
          <li>
            • Designed Authentication middleware using JSON Web Token and
            bcryptJs to handle passwords
          </li>
          <li>
