...
<>
 ...
 <section id="contact" className="bg-white dark:bg-gray-900">
  <div className="py-8 mt-12 lg:py-10 px-4 mx-auto max-w-screen-md">
      <h2 className="mb-1 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Send me a message:</h2>
      <MyLinks />
      ...
      <form ref={form} onSubmit={sendEmail} className="space-y-8  ">
          ...
          <div className="sm:col-span-2 drop-shadow-md">
